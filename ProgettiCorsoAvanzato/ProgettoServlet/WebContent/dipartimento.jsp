    	...
    	<input type="hidden" name="callType" id="callType" value="">	
		  <c:choose>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    <label for="nomeAzienda">Inserisci Azienda</label>
			    <input type="text" class="form-control" id="nomeAzienda" aria-describedby="nomeAzienda" name="nomeAzienda"  value="<c:out value="${dto.azienda.nome}"/>">
			  </div>
		  	</c:when>
		  	<c:otherwise>
				<div class="form-group">
			  ...
			  <div class="form-group">
			    <label for="nomeAzienda">Inserisci Azienda</label>
			    <input type="text" class="form-control" id="nomeAzienda" aria-describedby="nomeAzienda" name="nomeAzienda">
			  </div>
			</c:otherwise>  
		  </c:choose>
		  <button type="submit" class="btn btn-primary" id="inserisciBtn">Inserisci Dipartimento</button>
		  <button type="submit" class="btn btn-primary" id="modificaBtn">Modifica Dipartimento</button>
		  <button type="submit" class="btn btn-primary" id="eliminaBtn">Elimina Dipartimento</button>
		</form>
    </div>
